...
/**
 * Inference rule eliminate-or in natural deduction for propositional logic.
 * 
 * @author Stephen Siegel
 */
public class ElimOr extends Rule {

	public ElimOr(FormulaFactory fac) {
		super(fac);
	}
	...
	public Violation check(Sequent conclusion, Sequent... premises) {
		...
		if (v != null)
			return v;
		Sequent s0 = premises[0], s1 = premises[1], s2 = premises[2];
		...
		Formula a = fac.arg0(or), b = fac.arg1(or);
		...
		Formula c = conclusion.succedent(), c1 = s1.succedent(), c2 = s2.succedent();
		if (!c.equals(c1))
	...
	public boolean equals(Object obj) {
		return obj instanceof ElimOr;
	}

	@Override
	public int hashCode() {
		return ElimOr.class.hashCode();
	}
